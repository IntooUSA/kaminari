...
BANNER
      ...
      def template_engine
        ...
        if engine == 'haml' || engine == 'slim'
          ActiveSupport::Deprecation.send(:warn) 'The -e option is deprecated and will be removed in the near future. Please use the html2slim gem or the html2haml gem ' \
